...
public interface Collection<T> extends Iterable<T> {
	 ...
	 * will refuse to add {@code null}, and others will impose restrictions on the
	 ...
	 * 
	 * @throws IllegalArgumentException if the specified element is null and this
	 *                                  collection does not permit null elements
	 */
	boolean add(T element);

	/**
	 * Removes first appearance of the instance of the specified element from this
	 * collection, if it is present. More formally, removes an element {@code e}
	 * such that {@code o == null ? o == null : o.equals(e))}, if this collection
	 ...
	 * space).
	 * 
	 * Elements are converted to strings as by invoking their {@code toString}
	 * method.
	 *
