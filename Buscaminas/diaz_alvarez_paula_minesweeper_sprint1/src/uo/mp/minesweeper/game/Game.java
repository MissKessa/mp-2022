...
public class Game {
	 ...
	 * 
	 * @param board is the given board. It must be non-null elements
	...
	public void play() {
		...
		long end = 0;
		while (this.board.getNumberOfMinesLeft() > 0 && !this.board.hasExploded()) {
	 ...
	 *                    or equal to 0 and less than the row length of the board
	 * @param yCoordinate is the y-coordinate of the square. It must be greater than
	 *                    or equal to 0 and less than the column length of the board
