...
public class Game {
	 ...
	 * 
	 * @throws IllegalStateException if the game interactor, session interactor or
	 *                               logger hasn't been initiliazed yet
	 */
	public void play() {
		if (interactor == null)
	...
	/**
	 * It asks for the move and executes it. If any GameException or
	 * UserInteractionException has occur (due to an user error), it catches it and
	 * asks again
	 */
	 ...
	 * y-coordinate
	 * 
	 * @param move is the move to execute. It contains the coordinates and the
	 *             operation
	 ...
	 * @throws GameException             if the execution of the move is not valid
	 * @throws UserInteractionException  if the xCoordinate, yCoordinate or
