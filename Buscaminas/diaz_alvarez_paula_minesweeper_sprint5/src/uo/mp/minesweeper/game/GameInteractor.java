...
public interface GameInteractor {
	 ...
	 * 
	 * @param rows    is the maximum row that the user can enter. It must be in
	 *                [GameMove.MINIMUM_COORDINATE,GameMove.MAXIMUM_ROW_COORDINATE]
	 * 
	 * @param columns is the maximum column that the user can enter. It must be in
	 *                [GameMove.MINIMUM_COORDINATE,GameMove.MAXIMUM_COLUMN_COORDINATE]
	 * 
	 * @return a GameMove object containing the information provided by the user
	 * 
	 * @throws UserInteractionException if the coordinates or operation is invalid
