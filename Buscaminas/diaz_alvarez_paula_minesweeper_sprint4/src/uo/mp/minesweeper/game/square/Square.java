...
public class Square {
	...
	public void open() throws GameException {
		if (isOpened())
			throw new GameException("You tried to open a box that is already opened");
		this.state = StateSquare.OPENED;
	}
	...
	public void flag() throws GameException {
		if (!isClosed())
			throw new GameException("You tried to flag a box that is not closed");
	...
	public void unflag() throws GameException {
		if (!isFlagged())
			throw new GameException("You tried to unflag a box that is not flagged");
